...
class Baratheon(Character):
    """
    A class representing a member of House Baratheon, known for their strength, ambition, and tumultuous history.
    """
    def __init__(self, first_name, is_alive=True):
        """
        Initializes a Baratheon character with the given first name and default status of being alive.
        
        Parameters:
            first_name (str): The first name of the Baratheon character.
            is_alive (bool, optional): The status of the character's life. Default is True.
        """
...
class Lannister(Character):
    """
    A class representing a member of House Lannister, known for their wealth, cunning, and the phrase "A Lannister always pays his debts."
    """
    def __init__(self, first_name, is_alive=True):
        """
        Initialized a Lannister Character with the given first name and default status of being alive.
    ...
    def create_lannister(cls, first_name, is_alive=True):
        """
        creates a Lannister character with the given first name and status of being alive.
